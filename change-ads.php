...
<title>Promena oglasa | Besplatni mali oglasi</title>
...
<meta property="og:title" content="Promena oglasa | Besplatni mali oglasi">
<meta property="og:site_name" content="Besplatni Oglasi">
<meta property="og:url" content="http://besplatni-oglasi.esy.es/promeni-oglas">
...
<div class="col-md-8">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h2 class="panel-title"><br>&nbsp;&nbsp;&nbsp;Promena malog oglasa<br><br></h2>
    </div>
...
try {
	...
	on a.ads_curency = ac.curency_id
	 ...
	 left join ads_duration ad 
	 on a.duration_id = ad.id
	 
	 
	 left join ads_payement ap
	 on a.payment_id = ap.id
	 
	 
	 left join ads_shipping ash
	 on a.shipping_id = ash.id
	 
	 
	 left join ads_status s
	 on a.status_id = s.status_id
	 
	 
	
	
	where a.ads_id = :ads_id and a.user_id = :user_id limit 1 
	...
	$retrived_resaults = $query -> fetch ( PDO::FETCH_ASSOC);
	
	if((int)$retrived_resaults['user_id'] != (int)$_SESSION['user_id']){
		header('Location:/moji-oglasi');
		die();
...
echo '<h2>Uspešno ste promrnili vaš oglas</h2>';
header('Refresh:5;URL:/moji-oglasi');
die();
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                ...
                <option value="<?php echo $retrived_resaults['category_id'];?>"><?php echo $retrived_resaults['category_name'];?></option>
                <?php
				try {
				$sql = '
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                ...
                <option value="<?php echo $retrived_resaults['duration_id'];?>"><?php echo $retrived_resaults['duration_name'];?></option>
